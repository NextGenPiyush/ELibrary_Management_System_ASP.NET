                ...
                <div class="card"> 
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" Height="150px" Width="100px" src="imgs/book.jpeg" />
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                                        ...
                                        <asp:ListItem Text="Mrathi" Value="Mrathi" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox1" placeholder="Date" runat="server" TextMode="Date"></asp:TextBox>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:ListBox ID="ListBox1" CssClass="form-control" runat="server" SelectionMode="Multiple" Rows="5">
                                        ...
                                        <asp:ListItem Text="Thiller" Value="Thiller" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group"> 
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Decription" TextMode="Multiline"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div> 
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    &nbsp; | <span>Language - <span>&nbsp</span><asp:Label ID="Label4" runat="server" Font-Bold="True" Text='<%# Eval("language") %>'></asp:Label></span>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    &nbsp; | <span>Pages - <span>&nbsp</span><asp:Label ID="Label7" runat="server" Font-Bold="True" Text='<%# Eval("no_of_page") %>'></asp:Label>
                                                                        &nbsp; | <span> Edition - <span>&nbsp</span><asp:Label ID="Label8" runat="server" Font-Bold="True" Text='<%# Eval("edition") %>'></asp:Label>
                                                                             </span>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    &nbsp; | <span>Available - <span>&nbsp</span><asp:Label ID="Label11" runat="server" Font-Bold="True" Text='<%# Eval("current_stock") %>'></asp:Label></span>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
