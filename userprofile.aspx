                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="imgs/generaluser.jpeg" />
                                </center>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge badge-pill badge-info" ID ="Label2" runat="server" Text="Info about the due date"></asp:Label>
                                </center>
                            </div> 
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <asp:GridView class="table table-striped table-bordered" OnRowDataBound="GridView1_RowDataBound" ID="GridView1" runat="server"></asp:GridView>
                            </div>
                        </div> 
